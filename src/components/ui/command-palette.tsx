...
import {
  ...
  Settings, FileText, Lightbulb, ArrowRight, ClipboardList,
  CheckSquare, Library, GraduationCap, Map, Bell, Key, Plug, Brain,
  BookMarked, Target, Type, Newspaper, Gamepad2, Layers, MessageCircle,
  Layout, Award
} from 'lucide-react'
...
const commands = [
  ...
  { id: 'students',       label: 'Students',             icon: Users,           href: '/students',         category: 'Navigation' },
  { id: 'assignments',    label: 'Assignments',          icon: CheckSquare,     href: '/assignments',      category: 'Navigation' },
  { id: 'courses',        label: 'Courses',              icon: FolderOpen,      href: '/courses',          category: 'Navigation' },
  { id: 'gradebook',      label: 'Gradebook',            icon: BookOpen,        href: '/gradebook',        category: 'Navigation' },
  { id: 'groups',         label: 'Student Groups',       icon: Users,           href: '/groups',           category: 'Navigation' },
  { id: 'seating-chart',  label: 'Seating Chart',        icon: Layout,          href: '/seating-chart',    category: 'Navigation' },
  { id: 'attendance',     label: 'Attendance',           icon: CheckSquare,     href: '/attendance',       category: 'Navigation' },
  { id: 'curriculum',     label: 'Curriculum',           icon: Map,             href: '/curriculum',       category: 'Navigation' },
  ...
  { id: 'library',        label: 'Content Library',      icon: Library,         href: '/library',          category: 'Navigation' },
  { id: 'portfolio',      label: 'Student Portfolios',   icon: GraduationCap,   href: '/portfolio',        category: 'Navigation' },
  { id: 'reports',        label: 'Reports',              icon: FileText,        href: '/reports',          category: 'Navigation' },
  { id: 'report-cards',   label: 'Report Cards',         icon: FileText,        href: '/report-cards',     category: 'Navigation' },
  ...
  { id: 'professional-dev',label: 'PD Courses',          icon: Award,           href: '/professional-dev', category: 'Navigation' },
  { id: 'parent-portal',  label: 'Parent Portal',        icon: Users,           href: '/parent-portal',    category: 'Navigation' },
  // AI Tools
  { id: 'lesson-planner',        label: 'Lesson Planner',        icon: BookOpen,       href: '/lesson-planner',        category: 'AI Tools' },
  { id: 'quiz-builder',          label: 'Quiz Builder',          icon: ClipboardList,  href: '/quiz-builder',          category: 'AI Tools' },
  { id: 'feedback-writer',       label: 'Feedback Writer',       icon: MessageSquare,  href: '/feedback-writer',       category: 'AI Tools' },
  { id: 'rubrics',               label: 'Rubric Builder',        icon: PenTool,        href: '/rubrics',               category: 'AI Tools' },
  { id: 'standards',             label: 'Standards Library',     icon: Shield,         href: '/standards',             category: 'AI Tools' },
  { id: 'standards-unpacker',    label: 'Standards Unpacker',    icon: Layers,         href: '/standards-unpacker',    category: 'AI Tools' },
  { id: 'differentiation',       label: 'Differentiation',       icon: Brain,          href: '/differentiation',       category: 'AI Tools' },
  { id: 'word-wall',             label: 'Word Wall',             icon: BookMarked,     href: '/word-wall',             category: 'AI Tools' },
  { id: 'exit-tickets',          label: 'Exit Tickets',          icon: Target,         href: '/exit-tickets',          category: 'AI Tools' },
  { id: 'sub-plans',             label: 'Sub Plans',             icon: ClipboardList,  href: '/sub-plans',             category: 'AI Tools' },
  { id: 'text-leveler',          label: 'Text Leveler',          icon: Type,           href: '/text-leveler',          category: 'AI Tools' },
  { id: 'newsletter',            label: 'Newsletter Generator',  icon: Newspaper,      href: '/newsletter',            category: 'AI Tools' },
  { id: 'game-builder',          label: 'Game Builder',          icon: Gamepad2,       href: '/game-builder',          category: 'AI Tools' },
  { id: 'discussion-prompts',    label: 'Discussion Prompts',    icon: MessageCircle,  href: '/discussion-prompts',    category: 'AI Tools' },
  { id: 'accommodations',        label: 'IEP / 504 Plans',       icon: Shield,         href: '/accommodations',        category: 'AI Tools' },
  ...
  // Settings
  { id: 'integrations', label: 'Integrations', icon: Plug,    href: '/integrations', category: 'Settings' },
  { id: 'api-keys',     label: 'API Keys',     icon: Key,     href: '/api-keys',     category: 'Settings' },
]
