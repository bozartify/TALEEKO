    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="tools" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {tools.map((tool) => (
              <Link key={tool.label} href="/dashboard" className="tool-card group">
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link href="/dashboard" className="btn-gradient mt-8 inline-flex">Get started free</Link>
          </div>
          {/* Mock chat preview */}
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center hero-mesh rounded-3xl p-16 border border-slate-100">
          <div className="w-14 h-14 rounded-2xl mx-auto mb-6 flex items-center justify-center" style={{ background: 'linear-gradient(135deg,#8b5cf6,#6d28d9)' }}>
