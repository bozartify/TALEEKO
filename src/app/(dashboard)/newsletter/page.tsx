          ...
          <div className="lg:col-span-2 glass-card p-5">
            ...
            <div className="space-y-3">
              {pastNewsletters.map((nl, nli) => (
                <div key={nl.title} className="flex items-center gap-4 p-3 rounded-xl bg-white/[0.02] hover:bg-white/[0.04] transition-colors cursor-pointer group" onClick={() => { const t = nl.template as Template; setTemplate(t); setActiveSections(templateConfig[t].sections); setExpandedSection(templateConfig[t].sections[0]); setSubject(nl.title); showToast(`"${nl.title}" loaded into editor`) }}>
