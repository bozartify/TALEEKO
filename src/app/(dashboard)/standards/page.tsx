...
const frameworks = [
  { id: 'ccss', name: 'Common Core (CCSS)', icon: '\u{1F1FA}\u{1F1F8}', standards: 1465, aligned: 42, color: '#8b5cf6' },
  ...
  { id: 'cam',  name: 'Cambridge (IGCSE)', icon: '\u{1F1EC}\u{1F1E7}', standards: 280, aligned: 5, color: '#6366f1' },
