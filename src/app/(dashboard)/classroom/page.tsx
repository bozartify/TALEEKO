...
const classes = [
  ...
  { name: '8th Grade History', students: 31, lessons: 9,  color: '#c67954', subject: 'American History',        period: '3rd Period', avgScore: 82, trend: 'up' as const },
  { name: '9th Grade Math',    students: 25, lessons: 15, color: '#829c6e', subject: 'Algebra I',              period: '5th Period', avgScore: 79, trend: 'down' as const },
  { name: '10th Grade English',students: 29, lessons: 8,  color: '#d97b63', subject: 'Literature & Writing',   period: '7th Period', avgScore: 85, trend: 'up' as const },
]
