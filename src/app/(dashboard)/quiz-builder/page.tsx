                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <motion.button
                      ...
                      whileHover={{ y: -1 }}
                      whileTap={{ scale: 0.97 }}
                      onClick={() => { setQuestions(prev => [...prev, { id: `q${Date.now()}`, type: 'mcq', text: 'New question', points: 1, options: ['Option A', 'Option B', 'Option C', 'Option D'], correct: 0 }]); showToast('Blank question added') }}
                    >
